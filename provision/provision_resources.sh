...
BASE_DIR="vertexai-mlops/"
BUILD_TRIGGER_LOCATION="us-central1"
BUILD_TRIGGER_NAME="dry-beans-dt-build-trigger"
PIPELINE_JOB_SUBMISSION_SERVICE_IMAGE="us-central1-docker.pkg.dev/mdepew-assets/dry-beans-dt-artifact-registry/dry-beans-dt/submission_service:latest"
...
PIPELINE_JOB_RUNNER_SERVICE_ACCOUNT_LONG="vertex-pipelines@mdepew-assets.iam.gserviceaccount.com"
...
SOURCE_REPO_NAME="qarik-group/automlops"
SOURCE_REPO_BRANCH="feature/qarik-group"
STORAGE_BUCKET_NAME="mdepew-assets-dry-beans-dt-bucket"
